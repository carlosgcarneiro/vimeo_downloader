...
This script is useful for cases where traditionals downloaders are unable to download the video, for example on pages that require login or cookies.
...
**To use Python 3**
    ...
    sudo pip install git+https://github.com/mitsuhiko/flask-oauth
